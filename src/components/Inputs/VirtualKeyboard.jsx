  ...
  return (
    <div className="virtual-keyboard mx-auto flex-col">
        <div className="grid grid-cols-12 text-white text-lg">
            ...
            <div className="col-span-4 p-1">
                <button className="p-4 mx-auto shadow bg-primary keyBtn flex items-center justify-center text-xl rounded hover:opacity-75" onClick={() => {onKeyClicked('.')}}>.</button>
            </div>
            <div className="col-span-4 p-1">
            ...
            <div className="col-span-6 p-1">
                <button className="p-4 mx-auto shadow bg-red-400 keyBtnWide flex items-center justify-center text-xl rounded hover:opacity-75 " onClick={() => {onKeyClicked("back")}}>
                <span>
            ...
            <div className="col-span-6 p-1">
                <button className="p-4 mx-auto shadow bg-enter keyBtnWide flex items-center justify-center text-xl rounded hover:opacity-75" onClick={() => {onKeyClicked("enter")}}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
